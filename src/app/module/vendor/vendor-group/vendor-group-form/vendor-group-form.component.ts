...
@Component({
  ...
  styleUrls: ['./vendor-group-form.component.css']
})
export class VendorGroupFormComponent implements OnInit {


  public pageHeading = 'Vendor Group Form';
  public data: any;
  public status: any;
  public message: any;
  ...
  constructor(
    public masterService: VendorGroupService,
  ...
  goBack() {
    this.router.navigate(['/vendor-groups']);
  }
