...
export class AttributeListComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select', 'group_name', 'name', 'updated_at', 'action'];
  ...
  constructor(
    private masterService: AttributeService,
  ...
  edit(row) {
    this.router.navigate(['/attribute/', row.id]);
  }

  add() {
    this.router.navigate(['/attribute/', 'new']);
  }
