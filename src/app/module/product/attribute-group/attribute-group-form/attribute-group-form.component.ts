...
@Component({
  ...
  styleUrls: ['./attribute-group-form.component.css']
})
export class AttributeGroupFormComponent implements OnInit {


  public pageHeading = 'Attribute Group Form';
  public data: any;
  public status: any;
  public message: any;
  ...
  constructor(
    public masterService: AttributeGroupService,
  ...
  goBack() {
    this.router.navigate(['/attribute-groups']);
  }
