...
import { StockStatusService } from 'src/app/providers/stock/stock-status.service';
...
@Component({
  selector: 'app-stock-status-form',
  templateUrl: './stock-status-form.component.html',
  styleUrls: ['./stock-status-form.component.css']
})
export class StockStatusFormComponent implements OnInit {

  public pageHeading = 'Stock Status Form';
  public data: any;
  public status: any;
  public message: any;
  ...
  constructor(
    public masterService: StockStatusService,
  ...
  goBack() {
    this.router.navigate(['/stock-statuses']);
  }
