...
export class CustomerWishlistService {
  ...
  public list(data: any) {
    ...
    this.url = `${environment.url}customer/customer_wishlists`;
  ...
  public detail(id: any) {
    ...
    this.url = `${environment.url}customer/customer_wishlists/detail`;
  ...
  public delete(id: any) {
    this.url = `${environment.url}customer/customer_wishlists/delete/${id}`;
