...
export class LengthService {
  ...
  public list(data: any) {
    ...
    this.url = `${environment.url}unit/length_classes`;
  ...
  public detail(id: any) {
    ...
    this.url = `${environment.url}unit/length_classes/detail`;
  ...
  public delete(id: any) {
    this.url = `${environment.url}unit/length_classes/delete/${id}`;
  ...
  public deleteAll(data: any) {
    ...
    this.url = `${environment.url}unit/length_classes/delete_all`;
    return this.http.post<any>(this.url, this.formData).pipe(
      // retry(1), // retry a failed request up to 3 times
      catchError(this.configService.handleError)
    );
